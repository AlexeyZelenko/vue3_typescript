  ...
  <div class="row row-cols-1 row-cols-md-3 g-4">
      ...
      <div class="card h-100 text-center">
        ...
        >
          ...
          >
            ...
            <img
              :src="require(`@/assets/images/song.jpg`)"
    ...
    <div class="col">
      <div class="card h-100 text-center">
        <div class="card-header">
          <h5 class="card-title">Нічна молитва</h5>
        </div>
        <!--              <img-->
        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img :src="require(`@/assets/img/3.jpg`)" class="d-block w-100" alt="...">
              <div class="carousel-caption d-none d-md-block">
                <h5>Нічна молитва</h5>
              </div>
            </div>
            <div class="carousel-item">
              <img :src="require(`@/assets/images/nightprayer2.jpg`)" class="d-block w-100" alt="...">
            </div>
          </div>
        </div>
        <div class="card-body">
    ...
    <div class="col">
      <div class="card h-100 text-center">
        ...
        <img
          :src="require(`@/assets/images/homegroup.jpg`)"
          class="card-img-top"
          alt="..."
        >
        <div class="card-body">
